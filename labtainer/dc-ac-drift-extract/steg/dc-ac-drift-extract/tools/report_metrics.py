...
def main() -> None:
    parser = argparse.ArgumentParser(description="Report deterministic public metrics for the stego video.")
    ...
    data = {
        ...
        "estimated_ac_capacity_bits": estimated_ac_capacity_bits,
        "drift_compensation_note": "Full drift comparison is reserved for the drift-compensation-basic conversion.",
    }
