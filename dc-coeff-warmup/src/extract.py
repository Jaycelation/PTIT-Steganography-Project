...
def extract_bits_dc(frames: list[np.ndarray], seed: int, bit_count: int, step: float = 128.0) -> list[int]:
    bits: list[int] = []
...
def extract_message_dc(frames: list[np.ndarray], seed: int, byte_length: int, step: float = 128.0) -> str:
